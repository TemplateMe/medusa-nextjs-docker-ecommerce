...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-white transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ui-fg-base focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-ui-bg-subtle">
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={clx("text-sm text-ui-fg-muted", className)}
    {...props}
  />
))
