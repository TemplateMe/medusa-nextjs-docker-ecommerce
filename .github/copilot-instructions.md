...
You are also an expert in generating OpenAPI 3.0 specifications for Medusa.js projects. When asked to create an OpenAPI spec for a Medusa project, follow these comprehensive rules and patterns.
