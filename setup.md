...
AI indexation documentations:

https://docs.medusajs.com/
https://docs.stripe.com/
https://nextjs.org/docs
https://postgresql.org/docs/current/index.html
https://meilisearch.com/docs/home
...
3.3.12 - enable the checkbox for Stripe (pp_stripe_stripe or STRIPE) and click Save
...
5.1.6 - For the OAuth client ID:
   ...
   - Authorized redirect URIs:
     * http://localhost:8000/auth/callback/google (for local development)
     * https://yourstore.com/auth/callback/google (for production)
   - **Note**: The callback URL is now region-agnostic and does not require a country code.
...
GOOGLE_CALLBACK_URL=http://localhost:8000/auth/callback/google
```

5.2.3 - For production, update `GOOGLE_CALLBACK_URL` to your production domain:
```env
GOOGLE_CALLBACK_URL=https://yourstore.com/auth/callback/google
```
...
5.4.1 - Navigate to http://localhost:8000/account
...
- The callback URL should be: `http://localhost:8000/auth/callback/google`
- Do NOT include any country code in the path
